...
Tvshow.create(name: "The Eric André Show", type: "Talk Show", seasons: 4, startdate: DateTime.strptime("05/20/2012", "%m/%d/%Y"), enddate: DateTime.strptime("05/21/2012", "%m/%d/%Y"), creator: "Eric André", photo: "https://i.ytimg.com/vi/HhipOjmAI0c/maxresdefault.jpg")
